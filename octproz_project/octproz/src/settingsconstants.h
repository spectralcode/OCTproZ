...
// File paths
#define SETTINGS_PATH_BACKGROUND_FILE QStandardPaths::writableLocation(QStandardPaths::ConfigLocation) + "/background.csv"
#define SETTINGS_PATH_RESAMPLING_FILE QStandardPaths::writableLocation(QStandardPaths::ConfigLocation) + "/resampling.csv"
